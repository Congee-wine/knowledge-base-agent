...
- [PROJECT_STATUS.md](PROJECT_STATUS.md)：当前阶段、已验证范围、下一步和风险。
- [DEVELOPMENT_LOG.md](DEVELOPMENT_LOG.md)：本次文档基线整理及验证记录。
...
- [features/knowledge-retrieval/](features/knowledge-retrieval/README.md)：已确认的文本切分、`bge-m3` 向量化与资料范围检索设计；当前待实现。
